...
---@cast WarehouseInterface +fun(warehouseM:a546.WarehouseM,peripheralName:string,delay?:number,mayer?:function):a546.WarehouseInterface
---@param warehouseM a546.WarehouseM
---@param peripheralName string
function WarehouseInterface:new(warehouseM, peripheralName, delay, mayer)
